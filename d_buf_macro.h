...
#define dbuf_decl(T, N)                                                        \
  typedef struct dbuf_##N {                                                    \
    ...
    d_allocator alloc;                                                         \
                                                                               ...
                                                                               \
  static DATTR_UNUSED inline dbuf_##N dbuf_make_##N(isize init) {              \
    dbuf_data buf = {0};                                                       \
    dbuf_##N n = {0};                                                          \
                                                                               \
    ...
    return n;                                                                  \
                                                                               ...
                                                                               \
  static DATTR_UNUSED inline dbuf_##N dbuf_init_##N(T *data, isize init) {     \
    dbuf_data buf = {0};                                                       \
    dbuf_##N n = {0};                                                          \
                                                                               \
    buf.data = (void **)&n.data;                                               \
    ...
    return n;                                                                  \
                                                                               ...
                                                                               \
  static DATTR_UNUSED inline dbuf_##N dbuf_make_alloc_##N(isize init,          \
                                                          d_allocator alloc) { \
    dbuf_data buf = {0};                                                       \
    dbuf_##N n = {0};                                                          \
                                                                               \
    ...
    return n;                                                                  \
                                                                               ...
                                                                               \
  static DATTR_UNUSED inline dbuf_##N dbuf_init_alloc_##N(T *data, isize init, \
                                                          d_allocator alloc) { \
    dbuf_data buf = {0};                                                       \
    dbuf_##N n = {0};                                                          \
                                                                               \
    ...
    return n;                                                                  \
                                                                               ...
                                                                               \
  static DATTR_UNUSED inline void dbuf_push_##N(dbuf_##N *d, T i) {            \
    dbuf_data buf = {0};                                                       \
    ...
    _dbuf_push(&i, buf);                                                       \
                                                                               ...
                                                                               \
  static DATTR_UNUSED inline void dbuf_insert_##N(dbuf_##N *d, T i,            \
                                                  isize id) {                  \
    dbuf_data buf = {0};                                                       \
    buf.data = (void **)&d->data;                                              \
    buf.cur = &d->cur;                                                         \
    ...
    _dbuf_insert(&i, id, buf);                                                 \
                                                                               ...
                                                                               \
  static DATTR_UNUSED inline T dbuf_pop_##N(dbuf_##N *d) {                     \
    dbuf_data buf = {0};                                                       \
    buf.data = (void **)&d->data;                                              \
    buf.cur = &d->cur;                                                         \
    buf.len = &d->len;                                                         \
    ...
    return *x;                                                                 \
                                                                               ...
                                                                               \
  static DATTR_UNUSED inline T dbuf_get_##N(dbuf_##N *d, isize id) {           \
    dbuf_data buf = {0};                                                       \
    buf.data = (void **)&d->data;                                              \
    buf.cur = &d->cur;                                                         \
    buf.len = &d->len;                                                         \
    ...
    return *x;                                                                 \
                                                                               ...
                                                                               \
  static DATTR_UNUSED inline void dbuf_set_##N(dbuf_##N *d, isize id, T i) {   \
    dbuf_data buf = {0};                                                       \
    buf.data = (void **)&d->data;                                              \
    buf.cur = &d->cur;                                                         \
    buf.len = &d->len;                                                         \
